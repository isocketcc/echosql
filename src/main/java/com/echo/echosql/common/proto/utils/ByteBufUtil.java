...
public class ByteBufUtil {
     ...
     * @param b
     */
    public  final void writeByte(ByteBuf bf,byte b)
    {
        bf.writeByte(b);
    }
    /**
     ...
     * @param b
     */
    public  final void writeUB(ByteBuf buf,byte b)
    {
        buf.writeByte(b);
    }
    /***
     ...
     * @param i
     */
    public  final void writeUB2(ByteBuf buf,int i)
    {
     ...
     * @param i
     */
    public  final void writeUB3(ByteBuf buf, int i)
    {
        buf.writeByte((byte)(i & 0xFF));
        buf.writeByte((byte)((i >>> 8) & 0xFF));
     ...
     * @param l
     */
    public  final void writeUB4(ByteBuf buf,long l)
    {
     ...
     * @param i
     */
    public  final void writeInt(ByteBuf buf,int i)
    {
        buf.writeByte((byte)(i & 0xFF));
        buf.writeByte((byte)((i >>> 8) & 0xFF));
        buf.writeByte((byte)((i >>> 16) & 0xFF));
     ...
     * @param l
     */
    public  final void writeLong(ByteBuf buf,long l)
    {
        buf.writeByte((byte)(l & 0xFF));
        buf.writeByte((byte)((l >>> 8) & 0xFF));
        buf.writeByte((byte)((l >>> 16) & 0xFF));
     ...
     * @param l
     */
    public  final void writeLength(ByteBuf buf,long l)
    {
        if(l < 251)
        {
     ...
     * @param bs
     */
    public   final void writeBytes(ByteBuf buf,byte[] bs)
    {
        buf.writeBytes(bs);
    }
     ...
     * @param src
     */
    public  final void writeWithNull(ByteBuf buf,byte[] src)
    {
        buf.writeBytes(src);
     ...
     * @param src
     */
    public  final void writeWithVarLength(ByteBuf buf,byte[] src)
    {
     ...
     * @param nullValue
     */
    public  final void writeWithVarLength(ByteBuf buf,byte[] src,byte nullValue)
    {
        if(src == null)
        {
